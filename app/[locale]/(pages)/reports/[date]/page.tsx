  ...
  if (!report) {
    return (
      <section className="space-y-3">
        ...
        <Link href="/" className="text-sm text-gray-700 hover:text-black">{t('nav.backHome')}</Link>
      </section>
    );
  }
  ...
  return (
    <section>
      <div className="flex items-baseline justify-between gap-4">
        ...
        <Link href="/reports" className="text-sm text-gray-700 hover:text-black">{t('nav.archive')}</Link>
      </div>
